...
export function CTASection() {
  return (
    <section className="w-full pt-16 sm:pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-4 sm:px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-2xl sm:text-3xl md:text-5xl lg:text-[68px] font-semibold leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[435px]">
            Sẵn sàng làm chủ tiền bạc mỗi ngày?
          </h2>
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Bắt đầu ghi chép thu chi, theo dõi ngân sách và nhận gợi ý AI để chi tiêu chủ động hơn mỗi ngày cùng
            FinMate.
          </p>
        </div>
