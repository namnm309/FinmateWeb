...
const RealtimeCodingPreviews: React.FC = () => {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Khu vực báo cáo thời gian thực với màn hình dữ liệu và bản xem nhanh"
    >
      ...
      >
        ...
        >
          ...
          >
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}>baoCaoNgay({"{"}</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> thuNhap: 1200000,</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> chiTieu: 485000,</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> tietKiem: 715000,</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> mucChiLonNhat: 'Ăn uống',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> canhBao: 'Chi cao hơn 12%',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> goiY: 'Giảm 50.000đ hôm nay',</p>
