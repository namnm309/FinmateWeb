...
const AiCodeReviews: React.FC = () => {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Khối AI gợi ý phân loại giao dịch và nút áp dụng nhanh"
    >
      ...
      >
        ...
        >
          ...
          >
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}>ghiNhanGiaoDich({"{"}</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> moTa: 'Cà phê sáng',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> soTien: 45000,</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> danhMuc: 'Ăn uống',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> viTien: 'Ví hằng ngày',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> nhanDien: 'AI tự động',</p>
