...
const ParallelCodingAgents: React.FC<ParallelCodingAgentsProps> = ({ className = "" }) => {
  ...
  const agents = [
    {
      icon: <CheckmarkIcon />,
      title: "Cập nhật ngân sách ăn uống",
      tokens: "18 lượt phân tích",
      model: "AI Finance",
      branch: "Ngân sách tuần",
    },
    {
      icon: <RefreshIcon />,
      title: "Kiểm tra mục tiêu du lịch",
      tokens: "12 lượt phân tích",
      model: "AI Goals",
      branch: "Mục tiêu du lịch",
    },
    {
      icon: <SparklesIcon />,
      title: "Lên kế hoạch quỹ khẩn cấp",
      tokens: "24 lượt phân tích",
      model: "AI Planner",
      branch: "Quỹ dự phòng",
    },
  ]
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Các trợ lý AI theo dõi nhiều mục tiêu tài chính cùng lúc"
    >
